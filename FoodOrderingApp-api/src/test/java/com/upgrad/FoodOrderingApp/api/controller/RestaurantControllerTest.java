...
public class RestaurantControllerTest {
    ...
    public void shouldGetRestaurantDetailsForCorrectRestaurantId() throws Exception {
        ...
        when(mockCategoryService.getCategoriesByRestaurant(restaurantEntity))
        ...
        verify(mockCategoryService, times(1)).getCategoriesByRestaurant(restaurantEntity);
    ...
    public void shouldGetRestaurantDetailsByGivenName() throws Exception {
        ...
        assertEquals(restaurantList.getAddress().getId().toString(), restaurantEntity.getAddress().getId());
