...
import static com.upgrad.FoodOrderingApp.service.common.ItemType.ItemTypeEnum.NON_VEG;
...
public class CategoryControllerTest {
    ...
    public void shouldGetCategoryById() throws Exception {
        ...
        when(mockCategoryService.getCategoryItemsById("sampleCategoryId")).thenReturn((List<CategoryItemEntity>) categoryEntity);
        ...
        verify(mockCategoryService, times(1)).getCategoryItemsById("sampleCategoryId");
    }
    ...
    public void shouldNotGetCategoryByidIfCategoryIdIsEmpty() throws Exception {
        when(mockCategoryService.getCategoryItemsById(anyString()))
        ...
        verify(mockCategoryService, times(1)).getCategoryItemsById(anyString());
    }
    ...
    public void shouldNotGetCategoryByIdIfCategoryDoesNotExistAgainstGivenId() throws Exception {
        when(mockCategoryService.getCategoryItemsById("someCategory"))
        ...
        verify(mockCategoryService, times(1)).getCategoryItemsById("someCategory");
    }
