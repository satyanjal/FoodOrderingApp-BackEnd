...
public class RestaurantController {
    ...
    @Autowired
    private CategoryService categoryService; // Handles all the Service Related to category.
    ...
    */
    ...
    public ResponseEntity<RestaurantListResponse>getAllRestaurants(){
        ...
        for (RestaurantEntity restaurantEntity : restaurantEntities) { //Looping for each restaurant entity in restaurantEntities
            ...
            List<CategoryEntity> categoryEntities = categoryService.getCategoriesByRestaurant(restaurantEntity);
            ...
            RestaurantDetailsResponseAddress restaurantDetailsResponseAddress = new RestaurantDetailsResponseAddress()
                    .id(UUID.fromString(restaurantEntity.getAddress().getStateByUUID()))
